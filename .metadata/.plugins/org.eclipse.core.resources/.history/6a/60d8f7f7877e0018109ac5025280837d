...
<body>
	<div class="container" style="background-color: #ffffff">
	    ...
	    <div class="page-header">
	    	<h3>Employee Management - Edit Employee</h3>
	    </div>
		<div align="center">
			<form action="EditEmployee" method="post">
				<input type="hidden" id="employeeId" name="employeeId" value="<s:property value="employee.employeeId" />" />
				<table class="table table-responsive">
		            ...
		            <tr>
		                ...
		                <td>
		                    ...
		                    value="<s:property value="employee.city" />"/>
		                </td>
		            </tr>
		            <tr>
		                <th>Country: </th>
		                <td>
		                    ...
		                    value="<s:property value="employee.country" />"/>
		                </td>
		            </tr>
		            <tr>
		                <th>Department: </th>
		                <td>
		                    <select id="departmentId" name="departmentId">
								<s:iterator value="listDepartment">
								    ...
								    <s:if test="%{departmentId==employee.departmentId}">
										selected
									</s:if>
								    >
	  ...
	  <div class="modal-dialog" role="document">
	    <div class="modal-content">
	      <div class="modal-header">
	        <h5 class="modal-title">Edit Employee Successful</h5>
	        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
	          <span aria-hidden="true">&times;</span>
	        </button>
	      </div>
	      <div class="modal-body">
	        <p>You have successfully edited the employee data.</p>
	      </div>
	...
	<div class="modal" id="modalFailed" tabindex="-1" role="dialog">
	  <div class="modal-dialog" role="document">
	    <div class="modal-content">
	      <div class="modal-header">
	        <h5 class="modal-title">Edit Employee Failed</h5>
	        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
	          <span aria-hidden="true">&times;</span>
	        </button>
	      </div>
	      <div class="modal-body">
	        <p>Editing of employee is unsuccessful.</p>
	      </div>
	      <div class="modal-footer">
	        <a href="Welcome"><button type="button" class="btn btn-primary">Back to Home</button></a>
	        <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
